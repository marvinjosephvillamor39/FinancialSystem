<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            <a href="{{ route('incomes.index') }}" class="text-gray-400 hover:text-gray-600">← Back</a>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Income</h2>
        </div>
    </x-slot>
            ...
            <div class="bg-white rounded-xl shadow p-6">
                ...
                <form action="{{ route('incomes.update', $income) }}" method="POST">
                    ...
                    <div class="flex gap-3">
                        <button type="submit"
                                class="bg-green-500 hover:bg-green-600 text-gray font-semibold px-6 py-2 rounded-lg">
                            Update Income
                        </button>
